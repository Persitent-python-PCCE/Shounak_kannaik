...
from wtforms import StringField, TextAreaField, SelectField, SelectMultipleField, SubmitField, DateTimeLocalField
...
class EventForm(FlaskForm):
    ...
    genre_ids = SelectMultipleField("Genres", coerce=int, validators=[Optional()])
